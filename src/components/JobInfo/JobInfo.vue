...
export default {
  ...
  methods: {
    setEditable() {
      this.editable = true;
      this.$bvToast.toast(
        "Vous pouvez maintenant éditer toutes les caractéristiques de cette candidature.",
        {
          autoHideDelay: 3000,
          variant: "info",
          width: "55%",
    ...
    changeDateRelance() {
      ...
      dateCandidature.setDate(
        dateCandidature.getDate() + parseInt(this.job.dureeRelance)
      );

  ...
  <a @click="$router.go(-1)">
    ...
    >
      ...
      <path
        ...
        d="M8.4,23.317H27.329c.415,0,.752-.467.752-1.044V17.4c0-.577-.337-1.044-.752-1.044H8.4V12.35c0-1.86-1.62-2.792-2.568-1.476L.441,18.361a2.694,2.694,0,0,0,0,2.953L5.835,28.8c.948,1.315,2.568.384,2.568-1.476Z"
